  ...
  <div class="mainPart addLandlord">
    <el-form label-width="80px" :model="landlord" :rules="rules" ref="landlord">
      <el-form-item label="房东姓名" prop="customerName">
        <el-input v-model="landlord.customerName"></el-input>
      </el-form-item>
      <el-form-item label="房间"  prop="buildingRoomName">
        <el-input v-model="landlord.buildingRoomName" @focus="showChosingDialog"></el-input>
      </el-form-item>
      <el-form-item label="手机号"  prop="telphone">
        <el-input v-model="landlord.telphone"></el-input>
      </el-form-item>
      <el-form-item label="公司名称"  prop="companyName">
        <el-input v-model="landlord.companyName"></el-input>
      </el-form-item>
      <el-form-item>
