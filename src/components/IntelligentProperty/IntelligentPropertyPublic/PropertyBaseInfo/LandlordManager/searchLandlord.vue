  ...
  <div class="mainPart searchLandlord">
    <el-form :inline="true" :model="searchParams" class="demo-form-inline">
      ...
      <el-form-item label="房东姓名">
        <el-input v-model="searchParams.name" placeholder="房东姓名"></el-input>
      </el-form-item>
    ...
    <div class="clear20"></div>
    <el-button size="mini" type="primary" @click="showDelete">删除房东</el-button>
    <el-button type="primary" size="mini" @click="handleAdd">新增房东</el-button>
    <el-dialog
      :title="operationName"
      ...
      <el-form :model="currentRow" :rules="rules" ref="currentRow">
        <el-form-item label="房间名称" :label-width="formLabelWidth" prop="buildingRoomName">
          <el-input v-model="currentRow.buildingRoomName" auto-complete="off" @focus="showChosingDialog('operation')"></el-input>
        </el-form-item>
        <el-form-item label="房东姓名" :label-width="formLabelWidth" prop="customerName">
