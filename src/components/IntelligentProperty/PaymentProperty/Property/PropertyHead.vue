<template>
  <div class="header paymentPropertyHeader" id="paymentPropertyHeader">
...
<!--    <div class="logo_wraper">
      <div class="proper_logo">
        <a class="returnIndex" @click="returnToBusinessHome"></a>
        ...
        <div class="index_nav_container">
          <el-menu
           ...
           <!-- <el-menu-item index="/BusinessHome"><span class="nav_returnIndex"></span>居金所首页</el-menu-item>
            ...
            <el-menu-item :index="getFullPath('/PaymentManager/configPayment')">配置缴费项</el-menu-item>
            <el-menu-item :index="getFullPath('/PaymentManager/setPaymentStandard')">设定缴费标准</el-menu-item>
            <el-menu-item :index="getFullPath('/PaymentManager/createPropertyPaymentNotice')">生成缴费公告</el-menu-item>
            <el-menu-item :index="getFullPath('/PaymentManager/searchPaymentNotice')">缴费公告查询</el-menu-item>
            <el-menu-item :index="getFullPath('/PaymentManager/searchPaymentRecord')">缴费记录查询</el-menu-item>
            <el-menu-item :index="getFullPath('/PaymentManager/searchArrearsRecord')">未缴费记录查询</el-menu-item>
            <!--<el-submenu :index="getFullPath('/PaymentManager/configPayment')">-->
              <!--<template slot="title">收缴费管理</template>-->
              <!--<el-menu-item :index="getFullPath('/PaymentManager/configPayment')">配置缴费项</el-menu-item>-->
              <!--<el-menu-item :index="getFullPath('/PaymentManager/setPaymentStandard')">设定缴费标准</el-menu-item>-->
              <!--<el-menu-item :index="getFullPath('/PaymentManager/createPaymentNotice')">生成缴费公告</el-menu-item>-->
              <!--<el-menu-item :index="getFullPath('/PaymentManager/createPropertyPaymentNotice')">生成物业费缴费公告</el-menu-item>-->
              <!--<el-menu-item :index="getFullPath('/PaymentManager/searchPaymentNotice')">缴费公告查询</el-menu-item>-->
              <!--<el-menu-item :index="getFullPath('/PaymentManager/searchPaymentRecord')">缴费记录查询</el-menu-item>-->
              <!--<el-menu-item :index="getFullPath('/PaymentManager/searchArrearsRecord')">未缴费记录查询</el-menu-item>-->
            <!--</el-submenu>-->
           <!-- <el-submenu :index="getFullPath('/AccountsManager/accountsManage')">
              <template slot="title">账务管理</template>
              <el-menu-item :index="getFullPath('/AccountsManager/accountsManage')">我的账务</el-menu-item>
            </el-submenu>
...
<script>
  export default {
    ...
    data() {
      return {
        //基本路由
        base:"/PropertyCompany/PropertyManageSystem/IntelligentProperty/PaymentProperty/Property",
        //默认活动路由
        activeIndex: '/PropertyCompany/PropertyManageSystem/IntelligentProperty/PaymentProperty/Property/PaymentManager/configPayment',
        //面包屑导航
        crumbList:[],
        //公司名称
