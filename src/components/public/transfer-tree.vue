    ...
    <template v-if="mode == 'transfer'">
      ...
      <div class="transfer-left">
        ...
        <div class="transfer-main">
          <!-- <slot name="from"></slot> -->
          <el-input v-if="filter" placeholder="请输入员工名称" v-model="filterFrom" size="small" class="filter-tree">
          </el-input>
          <el-tree ref='from-tree'
                   :data="self_from_data"
                   show-checkbox
                   :node-key="node_key"
      ...
      <div class="transfer-center">
        ...
        <template v-else>
          ...
          <p class="transfer-center-item">
            <el-button type="success" @click='ensureChose'  icon="el-icon-check" circle></el-button>
          </p>
        </template>
      </div>
      <!-- 右侧穿梭框 目标框 -->
      <div class="transfer-right">
        ...
        <div class="transfer-main">
          <!-- <slot name='to'></slot> -->
          <el-input v-if="filter" placeholder="请输入员工名称" v-model="filterTo" size="small" class="filter-tree">
          </el-input>
          <el-tree
            slot='to'
            ref='to-tree'
      ...
      <div class="transfer-right">
        <div class="transfer-right-item" :class="{'transfer-right-small':move_up}">
          <h3 class="transfer-title">
            ...
            <img class="move_up_img move_down_img" v-else src="../../assets/images/public/shang.png" alt="" @click="moveUp('down')">
          </h3>
          <!-- 内容区 -->
        ...
        <div class="transfer-right-item" :class="{'transfer-right-small':!move_up}">
          <h3 class="transfer-title">
            ...
            <img class="move_up_img" v-else src="../../assets/images/public/shang.png" alt="" @click="moveUp('up')">
          </h3>
          <!-- 内容区 -->
          <div class="transfer-main" v-if='move_up'>
            <!-- <slot name='to'></slot> -->
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      console.log('haha',this.self_from_data)
    },
    methods: {
      // 添加按钮
      addToAims() {
        ...
        console.log('半选',harfKeys)
        console.log('整选',arrayCheckedNodes)
        console.log('不知道是什么',arrayHalfCheckedNodes)
      ...
      ensureChose(){
        // 获取选中通过穿梭框的keys - 仅用于传送纯净的id数组到父组件同后台通信
        // 传递信息给父组件
        this.$emit("ensureBtn", this.self_from_data, this.self_to_data);
      },
      // 源树选中事件 - 是否禁用穿梭按钮
    ...
    computed: {
      ...
      self_from_data() {
        ...
        console.log('from_data',from_array)
        return from_array;
      },
      // 右侧数据
      self_to_data() {
