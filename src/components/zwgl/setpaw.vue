        ...
        <div class="bindcard-con-body clearfix">
          <div class="block-con clearfix">
            ...
            <div class="fl input-type">
              <el-input v-model.number.trim="utel" placeholder="请输入手机号"></el-input>
            </div>
          </div>
          <div class="block-con clearfix">
              <span class="left-section fl same">
            ...
            <div class="fl input-type">
              <el-input v-model.trim="ucode" placeholder="请输入验证码"></el-input>
            </div>
            <div class="btns fl">
          ...
          <div class="block-con clearfix">
            ...
            <div class="fl input-type">
              <el-input v-model.trim="password" type="password" placeholder="请输入6位数的数字密码"></el-input>
            </div>
          </div>
          <div class="block-con clearfix">
              <span class="left-section fl same">
            ...
            <div class="fl input-type">
              <el-input v-model.trim="repassword" type="password" placeholder="重复密码"></el-input>
            </div>
          </div>
          <div class="text-tip">
