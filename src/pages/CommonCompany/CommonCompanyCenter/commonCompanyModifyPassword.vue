		...
		<div class="ygpay-wrap">
			<div class="main">
				<div class="main-cont">
					<div class="top-title">
						<div class="line"></div>
						<span class="top-text font14">修改密码</span>
					</div>
					<div class="contain">
						<div class="con-item clearfix">
							<div class="con-text fl beforesiteml">旧密码</div>
						...
						<div class="con-item clearfix">
							<div class="con-text fl beforesiteml">新密码</div>
							<div class="con-input fl">
						...
						<div class="con-item clearfix">
							<div class="con-text fl beforesiteml">确认密码</div>
							<div class="con-input fl">
	...
	export default {
      ...
      modifypsw() {
        if(this.oldPassword==''){
          ...
          this.$httpPasser.get('account/update', {
            params: {
