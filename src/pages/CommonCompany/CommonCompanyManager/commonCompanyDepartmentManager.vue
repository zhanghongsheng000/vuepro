<template>
	<div class="commmonCompanyDepartmentManager">
    ...
    <div class="tables">
        ...
        >
          <div class="inputstyle">
            <span>部门名称：</span>
            <el-input placeholder="请输入部门名称" v-model.trim="newdepartmentName" clearable></el-input>
          </div>
          <span slot="footer" class="dialog-footer">
    ...
    methods:{
      ...
      getDepartmentList(pageIndex){//获取部门列表
        this.$httpPasser.post('company/queryDepartmentByCompanyId',{
          ...
          if(res.data.resultCode=='200' && res.data.result !=null ){
...
.commmonCompanyDepartmentManager{
  width: 1040px;
	.tables{
      margin-bottom: 10px;
    }
