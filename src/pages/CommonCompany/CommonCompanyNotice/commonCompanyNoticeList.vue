      ...
      <el-table :data="noticeList" style="width: 100%" :empty-text=text>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" @click="toCommonCompanyNoticeDetails(scope.$index,scope.row)" round>详情</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
...
<script>
  export default {
    ...
    methods: {
      toCommonCompanyNoticeDetails(index, row) {//跳转详情
        this.$router.push({
...
//            noticeList:
      ...
      getCompanyNoticeList(index) { //获取物业公司已发送通知列表
