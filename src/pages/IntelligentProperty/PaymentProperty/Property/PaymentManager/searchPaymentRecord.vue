<template>
  <div class="mainPart searchPaymentRecord" id="searchPaymentRecord">
    <div>
      <div class="top-title" style="padding-top: 10px;">
        <div class="line"></div>
        <span class="top-text">缴费记录查询</span>
      </div>
    </div>
    <div class="choseForm">
      <el-form :model="buildingCascader">
        <el-form-item>
          <el-select v-model="buildingCascader.buildingGroupId" clearable placeholder="请选择楼盘" @change="getBuildingList">
            <el-option v-for="(buildingGroup,index) in buildingCascader.buildingGroupList" :key="index" :label="buildingGroup.buildingGroupName" :value="buildingGroup.buildingGroupId ">
            </el-option>
          </el-select>
          <el-select v-model="buildingCascader.buildingId" clearable placeholder="请选择写字楼" :disabled="hasBuilding">
            <el-option v-for="(building,index) in buildingCascader.buildingList" :key="index" :label="building.buildingName" :value="building.buildingId">
            </el-option>
          </el-select>
    ...
    <template>
      <el-table :data="paymentResults" style="width: 100%" @expand-change = "handleExpandChange"  ref="paymentResultsTable" row-class-name="get-row-class" :empty-text=text>
...
//        })
        this.$http.post("propertyCompany/getPropertyFeeRecord",{
