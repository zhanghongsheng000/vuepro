<template>
  <div id="materialsConfigureAdd">
    <div style="padding-top:20px;">
      <div class="top-title">
        <div class="line"></div>
        <span class="top-text">物料配置添加</span>
      </div>
    </div>
      ...
      <div class="form-item fl">
        <div class="items clearfix">
          ...
          <div class="item-ipt fl">
            <el-input v-model.trim="materielName" placeholder="请输入物料名称"  clearable></el-input>
          </div>
        </div>
        <div class="items clearfix">
          <div class="item-text beforesiteml fl">计量单位</div>
          <div class="item-ipt fl">
            <el-input v-model.trim="materielUnit" placeholder="请输入计量单位"  clearable></el-input>
          </div>
        </div>
        <div class="items clearfix">
          <div class="item-text fl">单价（元）</div>
          <div class="item-ipt fl">
            <el-input v-model.trim="materielPrice" placeholder="请输入单价"  clearable></el-input>
          </div>
        </div>
        <div class="items clearfix">
          <div class="item-text beforesiteml fl">物料分类</div>
          <div class="item-ipt fl" style="width: 202px;">
            <el-select v-model="materielParentId" placeholder="请选择"  clearable>
              <el-option
        ...
        <div class="items clearfix">
          ...
          <div class="item-ipt fl" style="width:202px;">
            <el-input
              ...
              placeholder="请输入内容"
              v-model="materielRemark"  clearable>
            </el-input>
          </div>
        </div>
        <div class="items">
  ...
  export default {
    ...
    data() {
      return {
        ...
        categroyName:'',//添加的物料分类名称
      	materielName:'',//服务项名称
        materielParentId:'',//物料分类名称
      	materielUnit:'',//服务项计量单位
				materielPrice:'',//服务项单价
				materielRemark:'',//服务项备注
    ...
    methods: {
      ...
      submitClick() {
        ...
        } else if (this.materielUnit == '') {
          this.$message({showClose: true, message: '请输入物料计量单位', type: 'error'})
        }else if(this.materielParentId == ''){
        	this.$message({showClose: true, message: '请选择物料分类', type: 'error'})
        } else {
          this.$httpPasser.post('materiel/save', {
          	customerUserId:this.customerUserId,
          	materielName:this.materielName,
          	materielUnit:this.materielUnit,
          	shopId:this.companyId,
          	materielId:this.materielId,
           	materielImgPath: this.htimageUrl,
           	materielParentId:this.materielParentId,
           	materielPrice:this.materielPrice,
           	materielRemark:this.materielRemark
          }).then(re => {
