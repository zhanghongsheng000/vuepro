		...
		<div class="main-cont">
			...
			<div class="main-box">
				<div class="forms-cont clearfix">
					...
					<div class="form-item fl">
						<el-select v-model="statusId" placeholder="请选择维修状态"  clearable>
				...
				<div class="tables">
					<el-table :data="getRepairDocuments" style="width: 100%">
                ...
                <div style="color: #000000;font-size: 16px;padding-bottom: 10px;padding-top: 10px">请选择维修人员进行派单：</div>
							...
							<el-table :data="dispatch.employeeList" style="width: 100%" @selection-change="handleSelectionChangeEmployee" :empty-text=text>
