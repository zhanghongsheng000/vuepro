	...
	<div id="repairListDetails">
		<div class="main-cont">
			...
			<div class="baseMessage clearfix">
				...
				<div class="repair_discribe clearfix" style="padding-bottom: 10px" v-if="baseMessage.faultDescription">
          <span style="color: #888;font-size: 14px">故障描述：</span>
          <div class="discribe_con">
						{{baseMessage.faultDescription}}
					</div>
				</div>
				<div class="repair_photo clearfix" style="display: inline-block;" v-if="baseMessage.imgList!=''">
					...
					<div v-for="item in baseMessage.imgList" style="display: inline-block;">
						<img :src="gImgUrl+item.imgPath" alt="">
				...
				<div class="repairPerson_style">
					<div class="repair_message clearfix">
						<div class="repairMessage_left fl" v-if="baseMessage.statusName == '已派单'||baseMessage.statusName == '待付款'||baseMessage.statusName == '维修中'||baseMessage.statusName == '已完成'">
							...
							<div class="fl" style="width: 340px;">
								<div v-for="person in baseMessage.employeeList" style="display: inline-block;" class="fl">
									<div style="display: inline-block; width: 160px;margin: 0 0px 10px 0;">
										<span style="background:#eee;padding: 5px 8px;">{{person.employeeName}}&nbsp;&nbsp;{{person.employeeTelphone}}</span>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="service_message" style="margin-left: 30px">
				<span>服务项明细：</span>
          ...
          <el-table-column prop="serviceItemSubtotal" label="小计">
			...
			<div class="materialsDetails" style="margin-left: 30px">
				<span>物料明细：</span>
