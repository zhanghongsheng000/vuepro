      ...
      <div class="form-item fl">
        <div class="items clearfix">
          ...
          <div class="item-ipt fl">
            <el-input v-model.trim="serviceItemName" placeholder="请输入服务项名称" clearable></el-input>
          </div>
        </div>
        <div class="items clearfix">
          <div class="item-text beforesiteml fl">计量单位</div>
          <div class="item-ipt fl">
            <el-input v-model.trim="serviceItemUnit" placeholder="请输入计量单位" clearable></el-input>
          </div>
        </div>
        <div class="items clearfix">
          <div class="item-text fl">单价（元）</div>
          <div class="item-ipt fl">
            <el-input v-model.trim="serviceItemPrice" placeholder="请输入单价" clearable></el-input>
          </div>
        </div>
        <div class="items clearfix">
        ...
        <div class="items clearfix">
          ...
          <div class="item-ipt fl" style="width: 202px;">
            <el-input
              ...
              placeholder="请输入内容"
              v-model="serviceItemRemark" clearable>
            </el-input>
          </div>
        </div>
        <div class="items">
