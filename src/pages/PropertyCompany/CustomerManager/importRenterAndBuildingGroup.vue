<template>
  <div id="importRenterAndBuildingGroup">
    <div style="padding-top:30px;">
      <div class="top-title">
        <div class="line"></div>
        <span class="top-text">租客导入(含写字楼)</span>
      </div>
    </div>
    ...
    <div class="tipDiv">
      ...
      <div class="tipContent">
        <ul class="tipUl">
          ...
          <li>二.【房间面积】和【公司入驻时间】为非必填字段。其他字段必须填写</li>
...
<script>
  ...
  export default {
    data(){
      return{
        currentName:"导入楼盘",
        action:$gPasserUrl+'buildingRoom/importBuildingAndTenant',
        //产品ID
        fileList: [],
        type:{
        ...
        downloadExcelUrl:$gDownLoad+'XX物业写字楼及租客统计表样例.xls',
        //上传头部
