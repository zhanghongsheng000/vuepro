    ...
    <el-form :model="buildingGroupInfo" :rules="rules" ref="buildingGroupInfo" label-width="100px"
      ...
      <div class="left">
        ...
        <el-form-item label="楼盘类型" prop="buildingType">
          <el-select v-model="buildingGroupInfo.buildingType" placeholder="请选择楼盘所在地区" clearable>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        buildingGroupInfo: {
          ...
          perRentAmount: '',//租赁价格  20180911 18:08张佳修改
          traffic:'',//交通状态
          info:'',//楼盘描述
          peripheryPic:[],//周边环境
          groupPic:[]//楼盘外观
        ...
        rules: {
          ...
          propertyYear:[
            { validator:this.checkPropertyYear, trigger: 'blur' }
          ]
        },
        /*
        * 地图插件部分变量
    ...
    methods: {
      //检验产权不能是负数
      checkPropertyYear(rule, value, callback){
        if (value<0) {
          callback(new Error('产权不能是负数'));
        } else {
          callback();
        }
      },
