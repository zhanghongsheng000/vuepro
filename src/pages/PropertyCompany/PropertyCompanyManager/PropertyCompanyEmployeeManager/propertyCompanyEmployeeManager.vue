        ...
        <div class="main-box">
          ...
          <div class="tables">
            <el-table :data="staffList" style="width: 100%"
                      ...
                      :empty-text=text
            >
              <el-table-column fixed type="selection"></el-table-column><!--:selectable="isNeedImproveCheckBoxFlag"-->
              <el-table-column type="index" width="50" label="编号" :index="indexMethod"></el-table-column>
              <el-table-column prop="departmentName" label="部门" width="70"></el-table-column>
              <el-table-column prop="workCode" label="工号" width="70"></el-table-column>
              ...
              <el-table-column prop="position" width="50" label="职位">
              ...
              <el-table-column prop="regulartTime" label="转正时间" width="110"></el-table-column>
              <el-table-column prop="telphone" label="手机号码" width="112"></el-table-column>
      ...
      <el-dialog title="添加员工" v-loading="loading2" element-loading-text="拼命加载中"
        ...
        <div class="entry-cocnt">
          ...
          <div class="sitem clearfix">
            ...
            <div class="sitemr fl">
              <el-input v-model.trim="workNumber" placeholder="请输入工号" clearable></el-input>
            </div>
          </div>
          <div class="sitem clearfix">
          ...
          <div class="sitem clearfix">
            <div class="siteml beforesiteml fl">密码：</div>
            <div class="sitemr fl">
      ...
      <el-dialog title="员工编辑" :visible.sync="dialogFormVisible2" width="464px" top="50px" :modal-append-to-body='false' :close-on-click-modal="false">
        <div class="entry-cocnt">
          ...
          <div class="sitem clearfix">
            <div class="siteml  fl">工号：</div>
            <div class="sitemr fl">
              <el-input v-model.trim="editWorkNumber" placeholder="请输入工号" clearable></el-input>
            </div>
          </div>
          <div class="sitem clearfix">
            <div class="siteml beforesiteml fl">姓名：</div>
          ...
          <div class="sitem clearfix">
            <div class="siteml beforesiteml fl">状态：</div>
            <div class="sitemr fl">
          ...
          <div class="sitem clearfix">
            ...
            <div class="sitemr fl">
              <el-select v-model="editPosition" placeholder="职位">
                <el-option v-for="item,index in positionList" :key="index" :label="item.name"
                           :value="item.customerPostId"></el-option>
              </el-select>
            </div>
          </div>
          <div class="sitem clearfix">
            <div class="siteml beforesiteml fl">手机号码：</div>
            <div class="sitemr fl">
              <el-input v-model.trim="editPhone" placeholder="请输入手机号码"></el-input>
            </div>
          </div>
          <div class="sitem clearfix">
            <div class="siteml beforesiteml fl">身份证号码：</div>
            <div class="sitemr fl">
              <el-input v-model.trim="editIdNum" placeholder="请输入身份证号码"></el-input>
            </div>
          </div>
          <div class="sitem clearfix">
            <div class="siteml beforesiteml fl">密码：</div>
            <div class="sitemr fl">
              <el-input v-model.trim="editPassword" placeholder="默认密码123456"></el-input>
            </div>
          </div>
        </div>
        <div slot="footer" class="dialog-footer">
  ...
  export default {
    data() {
      return {
        ...
        nonEmptyFiled:['departmentName','name','sex','status','entryTime','position','telphone','idCard']
      }
    },
    created() {
    ...
    methods: {
      ...
      editClick(row) {//编辑
        ...
        for (var m = 0; m < this.departmentList.length; m++) {
          if (this.departmentList[m].departmentName == row.departmentName) {
            ...
            this.oldSbumen = this.departmentList[m].departmentId;//编辑选择的部门
          }
        }
        this.editWorkNumber=row.workCode
        this.editSex = row.sex
        this.editName = row.name
        for (var i = 0; i < this.stateList.length; i++) {
          if (this.stateList[i].dictionariesValue == row.status) {
        ...
        for (var j = 0; j < this.positionList.length; j++) {
          if (this.positionList[j].customerPostId == row.position) {
            this.editPosition = this.positionList[j].customerPostId//职位
          }
        }
      ...
      editPreservation() {//编辑保存
        if (this.editName == '') {
          ...
          this.$httpPasser.post('employee/saveEmployee', {
            ...
            new_customer_department_id: this.oldSbumen,//旧部门ID
      ...
      stopClick(row) {//单个停职
        this.$httpPasser.post('employee/batchUpdateEmployee', {
      ...
      deleteBtn() {//多个删除
        ...
        if (this.selectNowList < 1) {
          ...
          this.$httpPasser.post('employee/deleteEmployee', {
            employeeIdList: this.selectNowList,
            shopId:gsid
          })
            .then(res => {
