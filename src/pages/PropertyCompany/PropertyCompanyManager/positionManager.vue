<template>
  <div class="PropertyDepartmentManager">
    ...
    <!--<div class="clearfix">
      ...
      <div class="fl pagestyle"> <span>共{{this.pageTotal}}页，当前第{{this.pageNow}}页 , 每页10条数据， 总共{{this.pagetotal}}条数据</span></div>
    </div>-->
      ...
      getDepartmentList(){//获取职位列表
        this.$httpPasser.post('companyPost/list',{
          ...
          if(res.data.resultCode=='200'){
            this.tableData=res.data.result?res.data.result:''
          }
          else{
          	this.text = "暂无数据"
            this.$message({
