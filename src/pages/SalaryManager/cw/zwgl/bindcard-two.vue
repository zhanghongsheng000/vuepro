          ...
          <div class="bindcard-con-body">
            ...
            <div class="block-con clearfix">
              ...
              <div class="fl input-type">
                <el-input v-model.trim="bankNum" placeholder="请输入银行卡号" clearable></el-input>
              </div>
            ...
            <div class="block-con clearfix">
              ...
              <div class="fl input-type">
                <el-input v-model.trim="bankPhone" placeholder="请输入银行预留手机号" clearable></el-input>
              </div>
              <span class="mi fl">*</span>
            </div>
            <div class="block-con clearfix">
              ...
              <div class="fl input-type">
                <el-input v-model.trim="zhiHang" placeholder="请输入支行名称(非必填)" clearable></el-input>
              </div>
            </div>
            <div class="btn-box">
        ...
        if(!this.radio){
          ...
          this.$http2.post('userBankCard/saveUserBankCard',{ //11.3 用户绑定银行卡接口
            ...
            .then(res=>{
              ...
              if(data.resultCode=='200'){
                console.log(data)
                this.$router.push({name:'CwBindCardTwos',query:{bankNum:this.bankNum,requestno:data.result.requestno} })
                this.$message({
                  showClose: true,
                  message: '验证码发送成功',
                  type: 'success'
