    ...
    <div class="nav">
      <div class="common clearfix">
        ...
        <div class="nav-list fr">
          <router-link class="list-item fl" to="/SalaryManager/ld/home">首页</router-link>
          <router-link class="list-item fl" to="/SalaryManager/ld/ApprovalPayfor">待审批工资表</router-link>
          <router-link class="list-item fl" to="/SalaryManager/ld/alApprovalPayfor">已审批公司表</router-link>
          <div class="mycenter fl" @mouseover="showBox" @mouseout="hideBox">
            ...
            <ul class="show-center" v-show="isShow">
              <li><router-link :to="{name:'ModifyPassword1'}" >修改密码</router-link> </li>
            </ul>
          </div>
        </div>
      </div>
