        ...
        <div class="main-box">
          <div class="forms-cont clearfix">
            ...
            <div class="form-item fr">
              <el-button type="primary" @click="dialogFormVisible = true">入职</el-button>
            </div>
          </div>
          <div class="tables">
            <el-table :data="staffList" style="width: 100%"
                      ...
                      @select-all="seleAll"
            >
              <el-table-column fixed type="selection"  :selectable="isNeedImproveCheckBoxFlag"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getstaffList(pagnum) {//获取员工列表
        ...
        let gsid = this.$local.sefetch('info').companyId
        this.$http.post('employee/getEmployeeByConditions', {
          productId,
          companyId: gsid,//公司
          pageIndex: pagnum,//页码
