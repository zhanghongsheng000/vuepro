    ...
    <div class="nav">
      <div class="common clearfix">
        ...
        <div class="nav-list fr">
          <router-link class="list-item fl" to="/SalaryManager/yg/home">首页</router-link>
          <router-link  class="list-item fl" :to="{name:'YgPayroll'}" >工资条</router-link>
          <router-link  class="list-item fl" :to="{path:'/SalaryManager/yg/accountsManage/accountsManage'}">账务管理111</router-link>
...
.salary-wrap{
  ...
  .nav{
    ...
    .logo{
      width: 320px;
      height: 80px;
      background:url("../../../assets/img/SalaryManager/sal-logo.png") left center no-repeat;
    }
    .nav-list{
      font-size: 16px;
      .list-item.active{
